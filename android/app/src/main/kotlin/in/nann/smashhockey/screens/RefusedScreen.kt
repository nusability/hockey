...
class RefusedScreen(game: Game, why: String) :
    ...
    init {
        part(WaveText(kit, L(CopyKey.REFUSED_TITLE), 0.15f, C.PINK, bob = 0.4f, id = "refused_title_header"), at(0f, top - 0.5f))
        val card = part(Panel(kit, 1.66f, 1.2f, 0.14f, C.PAPER, Entrance.Tumble), at(0f, top - 1.45f))
