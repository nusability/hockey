...
/// a live preview disk wearing the kit. Every rule the draft breaks is named under it. Part of the
/// team screen, shown on its "create" tab. The twin of Android's TeamForm.kt.
@MainActor
