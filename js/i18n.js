...
const S = {
  en: {
    ...
    'help.4': '<b>Drag</b> your finger away from where it landed while holding to <b>charge the shot</b>: the bar on the right fills up and the arrow grows. A plain tap is a medium shot.',
    'help.5': 'Defenders who reach your carrier steal the ball. Keep it moving: pass, pass, shoot.',
    'help.6': 'Start with <b>Training</b>: the first drills have no opponents, then dummies, then defenders that get faster each level.',
    'help.7': 'The season has a league and a cup, played in five worlds. Your team\'s automatic play follows the tactics on the coach\'s board.',
    // training
    ...
    'hud.goals': 'GOALS', 'hud.of': 'of {n}', 'hud.power': 'POWER', 'hud.vs': '{a} vs {b}',
  ...
  de: {
    ...
    'help.4': '<b>Ziehe</b> den Finger beim Halten von der Berührungsstelle weg, um den <b>Schuss aufzuladen</b>: Der Balken rechts füllt sich und der Pfeil wächst. Ein einfaches Tippen ist ein mittlerer Schuss.',
    'help.5': 'Verteidiger, die deinen Ballführer erreichen, stehlen den Ball. Halte ihn in Bewegung: passen, passen, schießen.',
    'help.6': 'Beginne mit dem <b>Training</b>: Die ersten Übungen haben keine Gegner, dann Dummys, dann Verteidiger, die mit jedem Level schneller werden.',
    'help.7': 'Die Saison hat eine Liga und einen Pokal, gespielt in fünf Welten. Das automatische Spiel deines Teams folgt der Taktik auf der Trainertafel.',
    ...
    'hud.goals': 'TORE', 'hud.of': 'von {n}', 'hud.power': 'KRAFT', 'hud.vs': '{a} gegen {b}',
